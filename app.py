...
def predict():
    ...
    model = joblib.load('model_pso.sav')
    predict = model.predict(final4)

    if predict == 0:
        output = "THE POLISH COMPANY IS NOT BANKRUPTCY BASED ON THE INPUT" 
    elif predict == 1:
        output = "THE POLISH COMPANY HAVE BEEN BANKRUPTCY BASED ON THE INPUT" 
